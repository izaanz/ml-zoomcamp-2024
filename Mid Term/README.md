...
The dataset contains approximately 500 rows. Given its small size, extensive model comparison was performed using various algorithms:
...
| ----------------- | ------------------ | ------------------ |
| Linear Regression | 0.988686360779384  | 0.9996078431372549 |
| Decision Tree     | 0.9006913890634821 | 0.9392156862745098 |
| Random Forest     | 0.9748585795097423 | 0.9811764705882353 |
| XGBoost           | 0.9773727215587681 | 0.9925490196078431 |
